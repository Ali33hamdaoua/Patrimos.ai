 ...
 * fond #0D1524 pour la profondeur, lueur or subtile dans la box-shadow.
 */
export const ContainerScroll = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex h-[45rem] items-center justify-center p-2 md:h-[55rem] md:p-20"
    >
      <div
...
/*    - bg-[#0D1524]             (au lieu de bg-[#222222])                    */
...
const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-[30rem] w-full max-w-5xl rounded-[30px] border-2 border-gold/30 bg-[#0D1524] p-2 shadow-2xl md:h-[40rem] md:p-6"
    >
